...
{% highlight text %}
## Error in names(dataset) <- c("name", "gender", "count", "year"): 'names' attribute [4] must be the same length as the vector [0]
{% endhighlight %}
...
{% highlight text %}
## Error: unknown variable to group by : gender
{% endhighlight %}
...
{% highlight text %}
## Error: unknown variable to group by : year
{% endhighlight %}
...
{% highlight text %}
## Error: unknown variable to group by : name
{% endhighlight %}
